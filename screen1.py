...
def screen1():
    ...
    while True:
        ...
        settings.screen.blit(createText(player2.rect.x, (255,255,255), 36), (settings.maxWidth - 32, 32))
        settings.screen.blit(createText(objectCollide[4], (255,255,255), 36), (settings.maxWidth - 132, 32))
        settings.screen.blit(createText(objectCollide[5], (255,255,255), 36), (settings.maxWidth - 232, 32))
        ...
        settings.screen.blit(createText(player2.rect.y, (255,255,255), 36), (settings.maxWidth - 32, 82))
        settings.screen.blit(createText(objectCollide[6], (255,255,255), 36), (settings.maxWidth - 132, 82))
        settings.screen.blit(createText(objectCollide[7], (255,255,255), 36), (settings.maxWidth - 232, 82))
